...
const InfoCard = ({info}: {info:Props}) => {
  return (
    <div className='flex flex-col md:justify-between gap-5 md:gap-0 w-full h-27 md:h-30 bg-white border border-[#E8E1D9] shadow-sm rounded-xl md:rounded-3xl p-2 px-3 md:p-4'>
