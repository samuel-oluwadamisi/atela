...
const Navbar = () => {
  return (
    <nav className='flex items-center justify-between h-20 bg-[rgba(255, 255, 255, 0.8)] w-full border-b border-b-[#E8E1D9]'>
        <div>
        <p className='text-[#2A1F1A] text-xl font-black'>Dashboard</p>
