...
import { MeasurementsType } from "../api/order.api";

const AccordionSection = ({ section,register, isOpen, onToggle}: { section: Section; register: UseFormRegister<MeasurementsType>; isOpen: boolean; onToggle: () => void;}) => { 
