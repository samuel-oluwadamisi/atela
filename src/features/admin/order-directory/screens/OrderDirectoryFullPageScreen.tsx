...
const OrderDirectoryFullPageScreen = ({order}: {order:OrderTableTypes} ) => {
  ...
  return (
  <>
    <div className='flex justify-end pr-20'><button onClick={()=> setEdit(!edit)}       className=" p-2 text-sm font-bold text-[#6E5F54] bg-[#E8E1D9] rounded-xl hover:bg-[#C1785A] hover:text-white transition-colors">{edit ? 'Save': 'Edit'}</button></div>
  ...
  <div className="flex flex-col gap-1">
    ...
    <input
      ...
      className={`border border-[#E8E1D9] bg-[#F7F4F0] rounded-xl px-3 py-2 text-sm text-[#2A1F1A] font-bold placeholder:text-xs placeholder:text-[#2A1F1A80] placeholder:font-bold outline-none focus:border-[#2A1F1A] transition-colors ${edit 
      ? "focus:border-[#2A1F1A]" 
      : "cursor-not-allowed"
    }`}
    />
  ...
  <div className="flex flex-col gap-1">
    <label className="text-xs font-bold text-[#6E5F54]">Garment Type</label>
    <input
      type="text"
      value={form.garment}
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div className="flex flex-col gap-1">
      <label className="text-xs font-bold text-[#6E5F54]">Select Stage to Start</label>
  ...
  {/* Section 2: Payments */}
  <h2 className="text-lg font-black text-[#2A1F1A]">Payments</h2>

  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div className="flex flex-col gap-1">
      <label className="text-xs font-bold text-[#6E5F54]">First Payment</label>
      <input
        type="text"
        placeholder="0"
    ...
    <div className="flex flex-col gap-1">
      <label className="text-xs font-bold text-[#6E5F54]">Second Payment</label>
      <input
        type="text"
        placeholder="0"
        className="border border-[#E8E1D9] bg-[#F7F4F0] rounded-xl px-3 py-2 text-sm text-[#2A1F1A] font-bold placeholder:text-xs placeholder:text-[#2A1F1A80] placeholder:font-bold outline-none focus:border-[#2A1F1A] transition-colors"
  ...
  <div className="flex flex-col gap-1">
    <label className="text-xs font-bold text-[#6E5F54]">Material Cost</label>
    <input
      type="text"
      placeholder="0"
      className="border border-[#E8E1D9] bg-[#F7F4F0] rounded-xl px-3 py-2 text-sm text-[#2A1F1A] font-bold placeholder:text-xs placeholder:text-[#2A1F1A80] placeholder:font-bold outline-none focus:border-[#2A1F1A] transition-colors"
  ...
  <div className="flex items-center gap-2">
    <input
      type="checkbox"
      className="w-4 h-4 accent-[#2A1F1A]"
    />
